...
import ozcan.cagirici.innovation.component.WeeklyReportTemplateBuilder;
import ozcan.cagirici.innovation.config.ComplianceSheetConfig;
import ozcan.cagirici.innovation.logger.WsLogger;
import ozcan.cagirici.innovation.model.PerformanceProductivityModel;
import ozcan.cagirici.innovation.model.WeeklyComplianceModel;
...
public class WeeklyReportService {
    ...
    public void buildWeeklyReportAndSendMail(final String manager, final String date, final boolean dryRun) throws IOException {
        ...
        List<PerformanceProductivityModel> performanceProductivityModels = performanceReportService.buildPerformanceReportAndSendMail(dryRun);

        String messageBody = weeklyReportTemplateBuilder.buildTemplate(weeklyReportModelMap, performanceProductivityModels);
        if (dryRun) {
