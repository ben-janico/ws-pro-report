...
import ozcan.cagirici.innovation.config.PerformanceSheetConfig;
...
public class PerformanceReportService {
    ...
    @Autowired
    private PerformanceSheetConfig performanceSheetConfig;

    private Map<String, PerformanceProductivityModel> performanceReportModelMap;

    public List<PerformanceProductivityModel> buildPerformanceReportAndSendMail(final boolean dryRun) throws IOException {
    ...
    private Map<String, PerformanceProductivityModel> readPerformanceSheet() {
        try {
            ValueRange response = sheetService.getGoogleSheetService()
                    .spreadsheets().values()
                    .get(performanceSheetConfig.getSource(),
                            performanceSheetConfig.getDataRange())
                    .execute();
